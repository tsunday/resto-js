    ...
    $.fn.jcImgScroll = function(options) {
        ...
        return this.each(function() {
            ...
            $IMGWRAPLIST = $("li", $IMGWRAP)
              ,
            fnGetIndexArr = function(index, len) {
                // å½“å‰ç´¢å¼•,é•¿åº¦
                ...
                for (b = 0; b <= len; b++) {
                    ...
                    // arrCurrIdx.unshift(index - (b + 1) < 0 ? 99 : index - (b + 1));
										if (index + (b + 1) == $IMGWRAPLIST.length)
											arrCurrIdx.push(0);
										else
											arrCurrIdx.push(index + (b + 1));

										if (index - (b + 1) < 0)
											arrCurrIdx.unshift($IMGWRAPLIST.length - 1);
										else
											arrCurrIdx.unshift(index - (b + 1));
                }
                ;
                return arrCurrIdx;
            }
            ...
            object.prototype.Initial = function(callback) {
                ...
                this.indexArr = fnGetIndexArr(this.centerIdx, this.centerCount);
                //èŽ•å–å½“å‰ç´¢å¼•ç»„
                    ...
                    for (c = 0; c < options.count; c++) {
                        if (a === this.indexArr[c]) {
                            var zindex = a > CenIdxArr ? a - t : a
                              ,
                            tmp = a > CenIdxArr ? a - this.centerIdx : t2
                              , //æ ¸å¿ƒç´¢å¼•
            ...
            function imgScroll(index, ArrData, dd) {
                ...
                var indedArr = fnGetIndexArr(index, _CENTER)
                  ,
                indedArrLen = indedArr.length
                  , i = null ;
                console.log(indedArr);
            ...
            $('li', _SELF).on('click', 'a', function(e) {
                e.preventDefault();
            ...
            if (options.title) {
                ...
                $IMGWRAPLIST.mouseleave(function() {
                    $(this).find("b").show().stop().animate({
                        "height": 0,
                        "opacity": 0
                    }, 150);
                    $(this).find("div").delay(150).stop().animate({
                        "opacity": 0
                    }, 100);
                    return false;
                }
